...
const Notepad = ({ isOpen, onClose }: NotepadProps) => {
	return isOpen ? (
		<Modal
			w="700px"
			h="500px"
		...
		>
			...
			>
				<div>
					...
					<p>
						<strong>Software Engineer</strong> | Alpha FX | London - UK
					</p>
					<p>SEPTEMBER 2025 - PRESENT</p>
					<ul>
						<li>
							Designed and implemented high-throughput payment APIs processing
							over $130b in annual transaction volume, ensuring scalability,
							reliability and low-latency performance.
						</li>
						<li>
							Led improvements to backend service architecture, improving code
							maintainability across NodeJS services.
						</li>
						<li>
							Implemented centralized, context-aware logging architecture
							leveraging Pino and AsyncLocalStorage in NodeJS for request
							tracking, improving observability and cutting debugging and
							incident-resolution times by 70%.
						</li>
						<li>
							Reduced cloud caching costs by implementing a local caching layer
							within the payment processing engine, minimizing redundant API
							calls and improving request performance.
						</li>
					</ul>
					<p>
						<strong>Mid Software Engineer</strong> | IMG Arena | London - UK
					</p>
					<p>JAN 2024 - SEPTEMBER 2025</p>
					<ul>
						<li>
						...
						<li>
							Designed and implemented high-performance APIs in Node.js,
							optimising server-side data processing and achieving a 50%
							increase in data retrieval speeds. Produced API documentation
							using Docusaurus.
						</li>
						<li>
					...
					<p>
						<strong>Junior Software Engineer</strong> | IMG Arena | London - UK
					</p>
					<p>JULY 2022 - JAN 2024</p>
					<p>
						Leveraged Kubernetes health checks and Datadog metrics to ensure
						resiliency of microservices. Built Datadog dashboards and configured
						alerting monitors for application health.
					</p>
					<p>
						Implemented state management in the React application, resulting in
						a 40% decrease in latency across thousands of WebSocket, GraphQL,
						and REST API messages.
					</p>
					<br />
					<p>
