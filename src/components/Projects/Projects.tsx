  ...
  return isOpen ? (
    ...
    >
      ...
      >
        <div>
          <h2>Projects</h2>
          <p>Amongst many, here are my highlighted project:</p>
          <hr />
          <h3>Data Console</h3>
          <p>
          ...
          <p>
            ...
            <GiJesterHat /> Tests, <SiVitest /> Playwright
          </p>
          ...
          <p>
            ...
            scratch, takes the Playwright results and produces a report card
            that helps diagnose the cause of the failure. The report card
            contains the test name, the reason for the failure, and a link to
            the tech stack
          </p>
          <p>
